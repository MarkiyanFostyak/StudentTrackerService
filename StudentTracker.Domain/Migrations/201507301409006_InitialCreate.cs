namespace StudentTracker.Domain.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.UiColours", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("dbo.StudentsCourses", "CourseRefId", "dbo.Courses");
            DropForeignKey("dbo.StudentsCourses", "StudentRefId", "dbo.Students");
            DropIndex("dbo.StudentsCourses", new[] { "CourseRefId" });
            DropIndex("dbo.StudentsCourses", new[] { "StudentRefId" });
            DropIndex("dbo.UiColours", new[] { "UserId" });
